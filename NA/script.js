...
async function main(){
  ...
  function userHtml(data){
    ...
    <div class="profile__info">
      <p class="profile__username">${data.username}</p>
      <p class="profile__bio">${data.bio}</p>
    </div>
    <button class="profile__unfollow" onclick="Remove(data)">Remove</button>
  </div>`
  }
 ...
 function Remove(str){
    return alert(`Sorry, ${str.username} does not have any content`)
  }
